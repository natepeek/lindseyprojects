...
View their code on their website
...
while True: # Keep asking until player enters a number.
...
snailNames = [] # List of string snail names.
for i in range(1, numSnailsRacing + 1):
    while True: # Keep asking until the player enters a vaild name.
...
for snailName in snailNames:
    print(snailNames[:MAX_NAME_LENGTH])
    print('@v')
